...
Source0  : https://files.pythonhosted.org/packages/90/8b/34d174ce519f859af104c722fa30213103d34896a07a4f27bde6ac780633/bracex-2.4.tar.gz
...
%prep
%setup -q -n bracex-2.4
cd %{_builddir}/bracex-2.4
pushd ..
cp -a bracex-2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693929788
...
cp %{_builddir}/bracex-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-bracex/e2b4724989b139f549c1ebc106c651a4e6d5228a || :
...
/usr/share/package-licenses/pypi-bracex/e2b4724989b139f549c1ebc106c651a4e6d5228a
