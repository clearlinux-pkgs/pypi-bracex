...
Source0  : https://files.pythonhosted.org/packages/ac/f1/ac657fd234f4ee61da9d90f2bae7d6078074de2f97cb911743faa8d10a91/bracex-2.5.tar.gz
...
%prep
%setup -q -n bracex-2.5
cd %{_builddir}/bracex-2.5
pushd ..
cp -a bracex-2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722872965
