...
Source0  : https://files.pythonhosted.org/packages/d6/6c/57418c4404cd22fe6275b8301ca2b46a8cdaa8157938017a9ae0b3edf363/bracex-2.5.post1.tar.gz
...
%prep
%setup -q -n bracex-2.5.post1
cd %{_builddir}/bracex-2.5.post1
pushd ..
cp -a bracex-2.5.post1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727563925
...
cp %{_builddir}/bracex-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-bracex/ca9bc0c98aa84aab2c941410d81b945cac3e1a88 || :
...
/usr/share/package-licenses/pypi-bracex/ca9bc0c98aa84aab2c941410d81b945cac3e1a88
